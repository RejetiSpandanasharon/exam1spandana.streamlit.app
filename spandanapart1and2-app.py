...
Original file is located at
    https://colab.research.google.com/drive/1PqSrLMyAOJfiguAOhEt6saPfOKNZyS8z
...
# Transform 'highway-mpg' to 'highway-L/100km'
...
# Write your code below and press Shift+Enter to execute
# Create an indicator variable for the 'aspiration' column
...
# Write your code below and press Shift+Enter to execute
# Check the shape of the final DataFrame (number of rows and columns)
...
Original file is located at
    https://colab.research.google.com/drive/1MzSyRo5VLSans97pyHp6S7sHsKS-H788
...
df_selected = df[['bore', 'stroke', 'compression-ratio', 'horsepower']]

# Make sure all columns are in float type (if needed)
...
# Display the correlation between stroke and price
...
# Plot regression between stroke and price
sns.regplot(x="stroke", y="price", data=df)

# Labels and title
plt.xlabel("Stroke")
plt.ylabel("Price")
plt.title("Linear Relationship Between Stroke and Price")
...
# Write your code below and press Shift+Enter to execute
# Group by 'body-style' and calculate the average 'price'
avg_price_by_body_style = df[["body-style", "price"]].groupby("body-style").mean()
